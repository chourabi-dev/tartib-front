...
export class NotesMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('mock/apps/notes/labels')
            .reply(({request}) =>
            {
                // Get label
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('mock/apps/notes/labels')
            .reply(({request}) =>
            {
                // Get label id
