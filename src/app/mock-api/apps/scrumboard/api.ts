...
export class ScrumboardMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            .onGet('mock/apps/scrumboard/boards')
            .reply(({request}) =>
            {
                // Clone the boards
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('mock/apps/scrumboard/board')
            .reply(({request}) =>
            {
                // Get the id
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPost('mock/apps/scrumboard/board/list')
            .reply(({request}) =>
            {
                // Get the list
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('mock/apps/scrumboard/board/list')
            .reply(({request}) =>
            {
                // Get the list
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('mock/apps/scrumboard/board/lists')
            .reply(({request}) =>
            {
                // Get the lists
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('mock/apps/scrumboard/board/list')
            .reply(({request}) =>
            {
                // Get the id
                const id = request.params.get('id');
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPut('mock/apps/scrumboard/board/card')
            .reply(({request}) =>
            {
                // Get the card
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('mock/apps/scrumboard/board/card')
            .reply(({request}) =>
            {
                // Get the id and card
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('mock/apps/scrumboard/board/cards')
            .reply(({request}) =>
            {
                // Get the cards
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('mock/apps/scrumboard/board/card')
            .reply(({request}) =>
            {
                // Get the id
                const id = request.params.get('id');
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('mock/apps/scrumboard/board/card/positions')
            .reply(({request}) =>
            {
                // Get the cards
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('mock/apps/scrumboard/board/labels')
            .reply(({request}) =>
            {
                // Get the board id
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPut('mock/apps/scrumboard/board/label')
            .reply(({request}) =>
            {
                // Get the label
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onPatch('mock/apps/scrumboard/board/label')
            .reply(({request}) =>
            {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onDelete('mock/apps/scrumboard/board/label')
            .reply(({request}) =>
            {
                // Get the id
                const id = request.params.get('id');
