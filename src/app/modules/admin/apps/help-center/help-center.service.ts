...
export class HelpCenterService
{
    ...
    {
        return this._httpClient.get<FaqCategory[]>('mock/apps/help-center/faqs').pipe(
            tap((response: any) =>
            {
    ...
    {
        return this._httpClient.get<FaqCategory[]>('mock/apps/help-center/faqs', {
            params: {slug},
        }).pipe(
            tap((response: any) =>
            {
    ...
    {
        return this._httpClient.get<GuideCategory[]>('mock/apps/help-center/guides', {
            params: {limit},
        }).pipe(
            tap((response: any) =>
            {
    ...
    {
        return this._httpClient.get<GuideCategory>('mock/apps/help-center/guide', {
            params: {
                categorySlug,
                guideSlug,
            },
