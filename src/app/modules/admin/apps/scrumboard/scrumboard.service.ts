...
export class ScrumboardService
{
    ...
    {
        return this._httpClient.get<Board[]>('mock/apps/scrumboard/boards').pipe(
    ...
    {
        return this._httpClient.get<Board>('mock/apps/scrumboard/board', {params: {id}}).pipe(
    ...
    createBoard(board: Board): Observable<Board>
    {
        return this.boards$.pipe(
            take(1),
            switchMap(boards => this._httpClient.put<Board>('mock/apps/scrumboard/board', {board}).pipe(
                map((newBoard) =>
                {
    ...
    updateBoard(id: string, board: Board): Observable<Board>
    {
        return this.boards$.pipe(
            take(1),
            switchMap(boards => this._httpClient.patch<Board>('mock/apps/scrumboard/board', {
                id,
                board,
            }).pipe(
                map((updatedBoard) =>
    ...
    deleteBoard(id: string): Observable<boolean>
    {
        return this.boards$.pipe(
            take(1),
            switchMap(boards => this._httpClient.delete('mock/apps/scrumboard/board', {params: {id}}).pipe(
    ...
    {
        return this._httpClient.post<List>('mock/apps/scrumboard/board/list', {list}).pipe(
    ...
    {
        return this._httpClient.patch<List>('mock/apps/scrumboard/board/list', {list}).pipe(
            map(response => new List(response)),
            tap((updatedList) =>
            {
                // Get the board value
    ...
    {
        return this._httpClient.patch<List[]>('mock/apps/scrumboard/board/lists', {lists}).pipe(
    ...
    {
        return this._httpClient.delete<boolean>('mock/apps/scrumboard/board/list', {params: {id}}).pipe(
            tap((isDeleted) =>
            {
                // Get the board value
                const board = this._board.value;
    ...
    {
        return this._httpClient.put<Card>('mock/apps/scrumboard/board/card', {card}).pipe(
    ...
    updateCard(id: string, card: Card): Observable<Card>
    {
        return this.board$.pipe(
            take(1),
            switchMap(board => this._httpClient.patch<Card>('mock/apps/scrumboard/board/card', {
                id,
                card,
            }).pipe(
                map((updatedCard) =>
    ...
    {
        return this._httpClient.patch<Card[]>('mock/apps/scrumboard/board/cards', {cards}).pipe(
    ...
    deleteCard(id: string): Observable<boolean>
    {
        return this.board$.pipe(
            take(1),
            switchMap(board => this._httpClient.delete('mock/apps/scrumboard/board/card', {params: {id}}).pipe(
                map((isDeleted: boolean) =>
                {
    ...
    createLabel(label: Label): Observable<Label>
    {
        return this.board$.pipe(
            take(1),
            switchMap(board => this._httpClient.post<Label>('mock/apps/scrumboard/board/label', {label}).pipe(
                map((newLabel) =>
                {
    ...
    updateLabel(id: string, label: Label): Observable<Label>
    {
        return this.board$.pipe(
            take(1),
            switchMap(board => this._httpClient.patch<Label>('mock/apps/scrumboard/board/label', {
                id,
                label,
            }).pipe(
                map((updatedLabel) =>
    ...
    deleteLabel(id: string): Observable<boolean>
    {
        return this.board$.pipe(
            take(1),
            switchMap(board => this._httpClient.delete('mock/apps/scrumboard/board/label', {params: {id}}).pipe(
                map((isDeleted: boolean) =>
                {
    ...
    search(query: string): Observable<Card[] | null>
    {
        ...
        return this._httpClient.get<Card[] | null>('mock/apps/scrumboard/board/search', {params: {query}});
    }
}
