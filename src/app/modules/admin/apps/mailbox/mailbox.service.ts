...
export class MailboxService
{
    ...
    {
        return this._httpClient.get<MailFilter[]>('mock/apps/mailbox/filters').pipe(
            tap((response: any) =>
            {
    ...
    {
        return this._httpClient.get<MailFolder[]>('mock/apps/mailbox/folders').pipe(
            tap((response: any) =>
            {
    ...
    {
        return this._httpClient.get<MailLabel[]>('mock/apps/mailbox/labels').pipe(
            tap((response: any) =>
            {
    ...
    getMailsByFilter(filter: string, page: string = '1'): Observable<any>
    {
        ...
        return this._httpClient.get<Mail[]>('mock/apps/mailbox/mails', {
            params: {
                filter,
                page,
            },
    ...
    {
        return this._httpClient.patch('mock/apps/mailbox/mail', {
            id,
            mail,
        }).pipe(
            tap(() =>
    ...
    addLabel(label: MailLabel): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.post<MailLabel>('mock/apps/mailbox/label', {label}).pipe(
                map((newLabel) =>
                {
    ...
    updateLabel(id: string, label: MailLabel): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.patch<MailLabel>('mock/apps/mailbox/label', {
                id,
                label,
            }).pipe(
    ...
    deleteLabel(id: string): Observable<any>
    {
        return this.labels$.pipe(
            take(1),
            switchMap(labels => this._httpClient.delete('mock/apps/mailbox/label', {params: {id}}).pipe(
                map((isDeleted: any) =>
                {
