...
export class TasksService
{
    ...
    {
        return this._httpClient.get<Tag[]>('mock/apps/tasks/tags').pipe(
            tap((response: any) =>
            {
    ...
    createTag(tag: Tag): Observable<Tag>
    {
        return this.tags$.pipe(
            take(1),
            switchMap(tags => this._httpClient.post<Tag>('mock/apps/tasks/tag', {tag}).pipe(
                map((newTag) =>
                {
    ...
    updateTag(id: string, tag: Tag): Observable<Tag>
    {
        return this.tags$.pipe(
            take(1),
            switchMap(tags => this._httpClient.patch<Tag>('mock/apps/tasks/tag', {
                id,
                tag,
            }).pipe(
                map((updatedTag) =>
    ...
    deleteTag(id: string): Observable<boolean>
    {
        return this.tags$.pipe(
            take(1),
            switchMap(tags => this._httpClient.delete('mock/apps/tasks/tag', {params: {id}}).pipe(
    ...
    {
        return this._httpClient.get<Task[]>('mock/apps/tasks/all').pipe(
            tap((response) =>
            {
    ...
    {
        return this._httpClient.patch<Task[]>('mock/apps/tasks/order', {tasks});
    }
    ...
    {
        return this._httpClient.get<Task[] | null>('mock/apps/tasks/search', {params: {query}});
    }
    ...
    createTask(type: string): Observable<Task>
    {
        return this.tasks$.pipe(
            take(1),
            switchMap(tasks => this._httpClient.post<Task>('mock/apps/tasks/task', {type}).pipe(
                map((newTask) =>
                {
    ...
    updateTask(id: string, task: Task): Observable<Task>
    {
        return this.tasks$
            .pipe(
                take(1),
                switchMap(tasks => this._httpClient.patch<Task>('mock/apps/tasks/task', {
                    id,
                    task,
                }).pipe(
                    map((updatedTask) =>
    ...
    deleteTask(id: string): Observable<boolean>
    {
        return this.tasks$.pipe(
            take(1),
            switchMap(tasks => this._httpClient.delete('mock/apps/tasks/task', {params: {id}}).pipe(
                map((isDeleted: boolean) =>
                {
