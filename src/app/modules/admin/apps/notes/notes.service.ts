...
export class NotesService
{
    ...
    {
        return this._httpClient.get<Label[]>('mock/apps/notes/labels').pipe(
            tap((response: Label[]) =>
            {
    ...
    {
        return this._httpClient.post<Label[]>('mock/apps/notes/labels', {title}).pipe(
            tap((labels) =>
            {
                // Update the labels
    ...
    {
        return this._httpClient.patch<Label[]>('mock/apps/notes/labels', {label}).pipe(
            tap((labels) =>
            {
                // Update the notes
    ...
    {
        return this._httpClient.delete<Label[]>('mock/apps/notes/labels', {params: {id}}).pipe(
            tap((labels) =>
            {
                // Update the notes
                this.getNotes().subscribe();
    ...
    {
        return this._httpClient.get<Note[]>('mock/apps/notes/all').pipe(
            tap((response: Note[]) =>
            {
    ...
    {
        return this._httpClient.post<Note>('mock/apps/notes/tasks', {
            note,
            task,
    ...
    {
        return this._httpClient.post<Note>('mock/apps/notes', {note}).pipe(
    ...
    updateNote(note: Note): Observable<Note>
    {
        ...
        return this._httpClient.patch<Note>('mock/apps/notes', {updatedNote}).pipe(
            tap((response) =>
            {
                // Update the notes
                this.getNotes().subscribe();
    ...
    {
        return this._httpClient.delete<boolean>('mock/apps/notes', {params: {id: note.id}}).pipe(
