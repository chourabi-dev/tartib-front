...
export class ChatService
{
    ...
    {
        return this._httpClient.get<Chat[]>('mock/apps/chat/chats').pipe(
            tap((response: Chat[]) =>
            {
    ...
    {
        return this._httpClient.get<Contact>('mock/apps/chat/contacts', {params: {id}}).pipe(
    ...
    {
        return this._httpClient.get<Contact[]>('mock/apps/chat/contacts').pipe(
            tap((response: Contact[]) =>
            {
    ...
    {
        return this._httpClient.get<Profile>('mock/apps/chat/profile').pipe(
    ...
    {
        return this._httpClient.get<Chat>('mock/apps/chat/chat', {params: {id}}).pipe(
            map((chat) =>
            {
                // Update the chat
    ...
    updateChat(id: string, chat: Chat): Observable<Chat>
    {
        return this.chats$.pipe(
            take(1),
            switchMap(chats => this._httpClient.patch<Chat>('mock/apps/chat/chat', {
                id,
                chat,
            }).pipe(
                map((updatedChat) =>
