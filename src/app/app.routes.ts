...
export const appRoutes: Route[] = [
  ...
  // Landing routes
  {
    ...
    children: [
      ...
      { path: 'article', loadChildren: () => import('app/modules/landing/article/article.routes') },
    ]
  },
  ...
  // Admin routes
  {
    ...
    children: [
      ...
      {
        path: 'projects',
        loadChildren: () => import('app/modules/admin/projects/projects-routes')
      },

      {
        path: 'articles',
        loadChildren: () => import('app/modules/admin/articles/articles-routes')
      },

      {
        path: 'configs',
        children: [
          { path: 'users', loadChildren: () => import('app/modules/admin/configs/users/users-routes') },
          { path: 'roles', loadChildren: () => import('app/modules/admin/configs/roles/roles-routes') },
          {
            path: 'nomenclatures',
            children: [
              { path: 'districts', loadChildren: () => import('app/modules/admin/configs/nomenclatures/districts/districts-routes') },
              { path: 'governorates', loadChildren: () => import('app/modules/admin/configs/nomenclatures/governorates/governorates-routes') },
              { path: 'delegations', loadChildren: () => import('app/modules/admin/configs/nomenclatures/delegations/delegations-routes') },
              { path: 'deanships', loadChildren: () => import('app/modules/admin/configs/nomenclatures/deanships/deanships-routes') },
              { path: 'pnd', loadChildren: () => import('app/modules/admin/configs/nomenclatures/pnd/pnd-routes') },
              { path: 'pnd-axis', loadChildren: () => import('app/modules/admin/configs/nomenclatures/pnd-axis/pnd-axis-routes') },
              { path: 'strategy', loadChildren: () => import('app/modules/admin/configs/nomenclatures/strategy/strategy-routes') },
              { path: 'strategy-axis', loadChildren: () => import('app/modules/admin/configs/nomenclatures/strategy-axis/strategy-axis-routes') },
              { path: 'minister', loadChildren: () => import('app/modules/admin/configs/nomenclatures/minister/minister-routes') },
              { path: 'sectors', loadChildren: () => import('app/modules/admin/configs/nomenclatures/sectors/sectors-routes') },
              { path: 'category', loadChildren: () => import('app/modules/admin/configs/nomenclatures/category/category-routes') },
              { path: 'currency', loadChildren: () => import('app/modules/admin/configs/nomenclatures/currency/currency-routes') },
              { path: 'organisation', loadChildren: () => import('app/modules/admin/configs/nomenclatures/organisation/organisation-routes') },
              { path: 'economic-nature', loadChildren: () => import('app/modules/admin/configs/nomenclatures/economic-nature/economic-nature-routes') },
              { path: 'study-state', loadChildren: () => import('app/modules/admin/configs/nomenclatures/study-state/study-state-routes') },
              { path: 'funding-source', loadChildren: () => import('app/modules/admin/configs/nomenclatures/funding-source/funding-source-routes') },
              { path: 'funding-source-type', loadChildren: () => import('app/modules/admin/configs/nomenclatures/funding-source-type/funding-source-type-routes') },
            ]
          },
        ]
      },
