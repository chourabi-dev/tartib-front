...
export class ShortcutsService
{
    ...
    {
        return this._httpClient.get<Shortcut[]>('mock/common/shortcuts').pipe(
            tap((shortcuts) =>
            {
    ...
    create(shortcut: Shortcut): Observable<Shortcut>
    {
        return this.shortcuts$.pipe(
            take(1),
            switchMap(shortcuts => this._httpClient.post<Shortcut>('mock/common/shortcuts', {shortcut}).pipe(
                map((newShortcut) =>
                {
    ...
    update(id: string, shortcut: Shortcut): Observable<Shortcut>
    {
        return this.shortcuts$.pipe(
            take(1),
            switchMap(shortcuts => this._httpClient.patch<Shortcut>('mock/common/shortcuts', {
                id,
                shortcut,
            }).pipe(
    ...
    delete(id: string): Observable<boolean>
    {
        return this.shortcuts$.pipe(
            take(1),
            switchMap(shortcuts => this._httpClient.delete<boolean>('mock/common/shortcuts', {params: {id}}).pipe(
